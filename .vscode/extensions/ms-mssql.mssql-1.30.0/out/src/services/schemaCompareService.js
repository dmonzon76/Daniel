...
class SchemaCompareService {
    ...
    publishDatabaseChanges(operationId, targetServerName, targetDatabaseName, taskExecutionMode) {
        ...
        return this._client.sendRequest(schemaCompareContracts.SchemaComparePublishDatabaseChangesRequest
            .type, params);
    }
    publishProjectChanges(operationId, targetProjectPath, targetFolderStructure, taskExecutionMode) {
        ...
        return this._client.sendRequest(schemaCompareContracts.SchemaComparePublishProjectChangesRequest
            .type, params);
    }

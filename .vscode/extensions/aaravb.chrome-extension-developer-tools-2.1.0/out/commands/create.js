...
exports.default = (context) => {
    ...
    let stylesSrc = initializationScreen.webview
        .asWebviewUri(vscode.Uri.file((0, path_1.join)(context.extensionPath, "webviews", "initialization_screen", "styles.css")))
        .toString();
    let scriptSrc = initializationScreen.webview
        .asWebviewUri(vscode.Uri.file((0, path_1.join)(context.extensionPath, "webviews", "initialization_screen", "index.js")))
        .toString();
    let chromeImgSrc = initializationScreen.webview
        .asWebviewUri(vscode.Uri.file((0, path_1.join)(context.extensionPath, "assets", "chrome.png")))
        .toString();

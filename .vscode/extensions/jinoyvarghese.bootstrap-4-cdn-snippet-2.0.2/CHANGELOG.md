...
- Added support for Django templates `django-html` support requested in [#15](https://github.com/Jinoy-Varghese/bootstrap-with-amp-cdn/issues/15) 🚀
- Added support for jinja templates `jinja-html` support requested in [#15](https://github.com/Jinoy-Varghese/bootstrap-with-amp-cdn/issues/15) 🚀
...
- Added full form with input, select and textarea. [#9](https://github.com/Jinoy-Varghese/bootstrap-with-amp-cdn/issues/9) - Thanks to [@wings30306](https://github.com/Wings30306) 🚀

#### Fixed

- Added a license [#8](https://github.com/Jinoy-Varghese/bootstrap-with-amp-cdn/issues/8) - This plugin now has a GNU GENERAL PUBLIC LICENSE. 🚀
...
- Space in Url for bootstrap. [#5](https://github.com/Jinoy-Varghese/bootstrap-with-amp-cdn/issues/5) 🐛
- Fixed popper.js unexpected token error. [#6](https://github.com/Jinoy-Varghese/bootstrap-with-amp-cdn/issues/6) 🐛
...
- Added Navigation snippets - Thanks to [@karnthis](https://github.com/karnthis) [#1](https://github.com/Jinoy-Varghese/bootstrap-with-amp-cdn/issues/1) 🚀
- Added Bootstrap4 CDN without jQuery - Thanks to [@nartc](https://github.com/nartc) [#2](https://github.com/Jinoy-Varghese/bootstrap-with-amp-cdn/issues/2) 🚀
- Added 2 basic form snippets: form-group and form-control Thanks to [@nartc](https://github.com/nartc) [#3](https://github.com/Jinoy-Varghese/bootstrap-with-amp-cdn/issues/3) 🚀
